...
def serve_map(
    ...
    cog_url = f"https://{bucket_name}.s3.us-east-2.amazonaws.com/public/{affiliation}/{fire_event_name}/{burn_metric}.tif"
    burn_boundary_geojson_url = f"https://{bucket_name}.s3.us-east-2.amazonaws.com/public/{affiliation}/{fire_event_name}/boundary.geojson"
    ecoclass_geojson_url = f"https://{bucket_name}.s3.us-east-2.amazonaws.com/public/{affiliation}/{fire_event_name}/ecoclass_dominant_cover.geojson"
    severity_obs_geojson_url = f"https://{bucket_name}.s3.us-east-2.amazonaws.com/public/{affiliation}/{fire_event_name}/burn_field_observations.geojson"
    cog_tileserver_url_prefix = (
        tileserver_endpoint
        + f"/cog/tiles/WebMercatorQuad/{{z}}/{{x}}/{{y}}.png?url={cog_url}&nodata=-99&return_mask=true"
    )

    rap_cog_annual_url = f"https://{bucket_name}.s3.us-east-2.amazonaws.com/public/{affiliation}/{fire_event_name}/rangeland_analysis_platform_annual_forb_and_grass.tif"
    rap_tileserver_annual_url = (
        tileserver_endpoint
        + f"/cog/tiles/WebMercatorQuad/{{z}}/{{x}}/{{y}}.png?url={rap_cog_annual_url}&nodata=-99&return_mask=true"
    )

    rap_cog_perennial_url = f"https://{bucket_name}.s3.us-east-2.amazonaws.com/public/{affiliation}/{fire_event_name}/rangeland_analysis_platform_perennial_forb_and_grass.tif"
    rap_tileserver_perennial_url = (
        tileserver_endpoint
        + f"/cog/tiles/WebMercatorQuad/{{z}}/{{x}}/{{y}}.png?url={rap_cog_perennial_url}&nodata=-99&return_mask=true"
    )

    rap_cog_shrub_url = f"https://{bucket_name}.s3.us-east-2.amazonaws.com/public/{affiliation}/{fire_event_name}/rangeland_analysis_platform_shrub.tif"
    rap_tileserver_shrub_url = (
        tileserver_endpoint
        + f"/cog/tiles/WebMercatorQuad/{{z}}/{{x}}/{{y}}.png?url={rap_cog_shrub_url}&nodata=-99&return_mask=true"
    )

    rap_cog_tree_url = f"https://{bucket_name}.s3.us-east-2.amazonaws.com/public/{affiliation}/{fire_event_name}/rangeland_analysis_platform_tree.tif"
